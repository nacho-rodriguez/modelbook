    ...
    <div class="panel panel-default panel-properties">
        <div class="row">
            <?php if ($bookingInfo->estado_reserva == 1) { ?>
				...
				<div class='col-lg-4 col-md-4 col-lg-offset-5 col-md-offset-5 text-right'>
        ...
        <div style="margin-top: 16px;" class="well text-center">
            <h5> Esta reserva ha sido realizada por: <?php echo $sellerName; ?></h5>
        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingTwo">
                            <h5 class="text-center">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#clients"
                                   href="#client<?php echo $numberClient; ?>" aria-expanded="false"
                                   aria-controls="client<?php echo $numberClient; ?>">
                                    <?php echo $name; ?>
                                </a>
                            </h5>
                        </div>
                        <div id="client<?php echo $numberClient; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="client<?php echo $numberClient; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5>¿Está seguro de anular esta reserva? No podrá volverla a activar.</h5>
            </div>
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <form style="padding-left: 0 !important;" method="post" action="<?php echo base_url('admin/bookings/cancelbooking'); ?>">
							<input style="display: none;" name="bookingID" value="<?php echo $bookingInfo->id_reserva; ?>"/>
                            <input style="margin-left: 5px; margin-bottom: 5px;" type="submit" class="btn btn-md btn-danger" value="Anular reserva"/>
                        </form>
                    </div>
                </div>
            </div>
